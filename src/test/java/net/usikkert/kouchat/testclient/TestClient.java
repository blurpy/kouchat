...
public class TestClient {
    ...
    public TestClient(@NonNls final String nickName, final int userCode, final int ownColor) {
        ...
        controller = new Controller(ui, settings, settingsSaver, coreMessages, errorHandler);
    ...
    /**
     * Gets one of the users this client knows about.
     *
     * @param nickName Nick name of the user to get.
     * @return The user, if found.
     * @throws RuntimeException If user is not found.
     */
    public User getUser(final String nickName) {
        final User user = controller.getUser(nickName);

        if (user == null) {
            throw new RuntimeException("Unknown user: " + nickName);
        }
